...
public class ConnectToServer : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
       ...
       hostButton.onClick.AddListener(() => {
            ...
            PhotonNetwork.NickName = nameInputField.text; // ✅ Set BEFORE creating room
        ...
        clientButton.onClick.AddListener(() => {
            ...
            PhotonNetwork.NickName = nameInputField.text; // ✅ Set BEFORE joining room
    ...
    public override void OnConnectedToMaster()
    {
        ...
        // Automatically join lobby so you can join/create rooms
        PhotonNetwork.JoinLobby(); 
    }

    public override void OnJoinedRoom()
    {
        //PhotonNetwork.NickName = nameInputField.text; ❌ too late here
        SetCustomProperties();
